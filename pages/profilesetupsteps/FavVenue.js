...
function FavVenue({ setStep }) {
  return (
    <ScrollView>
      <View style={style.container}>
        <Text style={style.label}>Venue Selection</Text>

        <View style={style.favWrapper}>
          <Text style={style.text}>FAVORITE </Text>
          <Text style={{ ...style.text, fontWeight: "900" }}>LOCATION</Text>
        </View>

        <View style={{ ...style.wrapper, backgroundColor: "#00FF0A" }}>
