...
/*
 * Phone codes of all the countries
 */
const countryCodes = [
  "Afghanistan(+93)",
  "Aland Islands(+358)",
...
function GetPhone({ setStep }) {
  return (
    <View>
      <View style={{ width: "100%" }}>
        <Text style={style.label}>Enter your phone number</Text>
        <View
          style={{
            flexDirection: "row",
            width: "100%",
          ...
          <View style={style.dropDownWrapper}>
            <SelectDropdown
              ...
              buttonTextAfterSelection={(selectedItem, index) => {
                /*
                 *Extract dial code from Selected Country
                 */
                const startingIndex = selectedItem.indexOf("(");
                const endingIndex = selectedItem.indexOf(")");
                const dial_code = selectedItem.substring(
                  startingIndex + 1,
                  endingIndex
                );
                return dial_code;
      ...
      <StepButton text="Send Code" onPress={setStep} />
    </View>
  );
}

export default memo(GetPhone);
